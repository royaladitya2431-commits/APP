...
class report:
    ...
    #Class Variable
    company_name="ADITYA technologies pvt.ltd."
...
r1 = report("Advanced Python Practical Report", "Aditya Patil")
...
r1.add_content("Report prepared by Aditya Patil.")
...
r2 = report("Employee Performance Report", "Aditya Patil")

r2.add_content("Employee Name : Rohit Sharma")
...
r3 = report("Student Result Report", "Aditya Patil")
